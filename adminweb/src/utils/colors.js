...
function buildPalette(hex) {
    ...
    return {
        ...
        ...o(tinycolor.mix(white, hex, 5), "50"),
        ...o(tinycolor.mix(white, hex, 15), "100"),
        ...
        ...o(tinycolor.mix(baseDark, hex, 80), "600"),
        ...o(tinycolor.mix(baseDark, hex, 55), "700"),
        ...o(tinycolor.mix(baseDark, hex, 31), "800"),
        ...o(tinycolor.mix(baseDark, hex, 3), "900"),
        ...o(
            tinycolor
